...
public sealed class MicrophoneSelectPopup : Node
{
    ...
    public MicrophoneSelectPopup(List<string> devices, int selectedIndex = 0)
    {
    ...
    public override void Draw()
    {
        ...
        Text.DrawPro(_fontTitle, "Capture devices", new Vector2(rect.X + 16, rect.Y + 12), origin: new Vector2(0, 0));
